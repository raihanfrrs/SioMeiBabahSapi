...
export const metadata: Metadata = {
  ...
  description: "Sio Mei adalah siomay sapi premium handmade dari Babah Sapi, dibuat dari daging pilihan dengan tekstur lembut, gurih, dan siap dikirim hangat.",
