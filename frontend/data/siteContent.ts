export const siteContent = {
  ...
  processSteps: [
    {
      number: "01",
      title: "Pilih Bahan",
      text: "Bahan utama dipilih dengan standar kualitas agar rasa dan tekstur tetap konsisten.",
    },
    {
      number: "02",
      title: "Olah Adonan",
      text: "Adonan diracik hingga menghasilkan tekstur siomay yang lembut, padat, dan juicy.",
    },
    {
      number: "03",
      title: "Kukus & Sajikan",
      text: "Siomay dikukus hingga matang sempurna, lalu disajikan dengan bumbu kacang khas.",
    },
  ],
  foods: [
    {
  ...
  mission: {
    headline: "Dibuat dengan rasa, disajikan dengan hati.",
    text: "Kami percaya makanan yang baik bukan hanya soal kenyang, tapi juga soal pengalaman. Karena itu, setiap porsi Sio Mei Babah Sapi dibuat untuk menghadirkan rasa hangat, akrab, dan memuaskan.",
    stats: [
      { label: "Rasa Otentik", value: "100%" },
      { label: "Kepuasan", value: "Premium" },
