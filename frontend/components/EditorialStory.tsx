...
const EditorialStory = () => {
  ...
  return (
    <section 
      ...
      className="w-full bg-brand-cream pt-28 md:pt-36 lg:pt-44 pb-32 md:pb-40 lg:pb-56 overflow-hidden border-t border-[#2a140d]/10"
    >
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-20 items-center">
          
          {/* Left: Large Editorial Heading */}
          <div className="md:col-span-6 flex flex-col items-start editorial-reveal px-8 md:px-0">
