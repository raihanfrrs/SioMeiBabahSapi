  ...
  return (
    <section className="bg-brand-cream pt-24 md:pt-24 pb-32 md:pb-48 border-t border-brand-dark/5 flex justify-center">
      <div className="max-w-7xl w-full px-6 md:px-12 lg:px-20 grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 items-center">
        ...
        >
          <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-brand-dark/30">Keahlian Kami</span>
          <h2 className="text-5xl md:text-7xl font-editorial font-medium leading-[1.05] text-brand-dark">
          ...
          <Link 
            href="/#process" 
            className="flex items-center gap-4 text-[10px] font-bold uppercase tracking-[0.3em] text-brand-dark/40 hover:text-brand-dark transition-all group"
          >
