  ...
  return (
    <section className="relative min-h-screen w-full flex flex-col justify-center items-center overflow-hidden mb-20 md:mb-80">
      ...
      <div className="relative z-10 max-w-7xl w-full px-6 md:px-12 lg:px-20 grid grid-cols-1 md:grid-cols-12 items-center md:items-end gap-16 md:gap-12 pb-32 md:pb-48">
        ...
        >
          <h1 className="editorial-display text-brand-cream max-w-3xl drop-shadow-sm">
            {hero.headline}
          </h1>
        </motion.div>

        {/* Right Side - Subtext & CTA */}
        <div className="md:col-span-5 flex flex-col items-start md:items-end md:text-right gap-12 pb-10">
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 1, delay: 0.5 }}
            className="text-[14px] text-brand-cream/90 max-w-[240px] leading-relaxed font-medium"
          >
            {hero.subheadline}
          </motion.p>
